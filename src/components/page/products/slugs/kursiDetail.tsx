...
export default function KursiDetail() {
  return (
    <>
      <div className="w-full flex flex-col p-5">
        ...
        <div className="my-10 flex flex-col gap-5">
          <div>
            <p className="lg:text-6xl text-4xl text-white font-black">Kursi Detail</p>
          </div>
          <div role="tablist" className="tabs tabs-lifted">
            ...
            >
              <div className="flex md:flex-row flex-col gap-5">
                <div className="w-full">
                  <Image
                    src={`/produk/product list/kursi/kursi-1.jpeg`}
                    alt="Kursi Image"
            ...
            >
              <div className="flex md:flex-row flex-col gap-5">
                <div className="w-full">
                  <Image
                    src={`/produk/product list/kursi/kursi-2.jpeg`}
                    alt="Kursi Image"
                    className="w-full border-4 border-solid border-black rounded-md"
                    width={1000}
                    height={1000}
